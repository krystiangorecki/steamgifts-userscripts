...
function addLowcyGierBazarLink() {
    $('.giveaway__heading__name').each(function (index, element) {
        ...
        if (!alreadyHasBazarLink) {
            ...
            bazarLink.innerHTML = '<img src="https://bazar.lowcygier.pl/favicon.ico" style="height:16px; margin-bottom: -3px; margin-left: 6px;"/>'
